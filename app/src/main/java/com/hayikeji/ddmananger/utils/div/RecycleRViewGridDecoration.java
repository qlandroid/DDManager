package com.hayikeji.ddmananger.utils.div;
...
public class RecycleRViewGridDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecycleRViewGridDecoration(int space) {
        this.space = space;
    }

    public RecycleRViewGridDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public RecycleRViewGridDecoration(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RecycleRViewGridDecoration(int space, Drawable mDivider) {
        this.space = space;
