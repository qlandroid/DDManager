...
import com.hayikeji.ddmanager.ui.activity.AppVersionActivity;
import com.hayikeji.ddmanager.ui.activity.CommWebActivity;
import com.hayikeji.ddmanager.ui.activity.EManagerActivity;
import com.hayikeji.ddmanager.ui.activity.EUseRecordActivity;
import com.hayikeji.ddmanager.ui.activity.LoginActivity;
import com.hayikeji.ddmanager.ui.activity.MyDevListActivity;
import com.hayikeji.ddmanager.ui.activity.PayEActivity;
import com.hayikeji.ddmanager.ui.activity.PayVipActivity;
import com.hayikeji.ddmanager.ui.activity.UserDetailsActivity;
...
import com.hayikeji.ddmanager.ui.adapter.MyNavAdapter;
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                switch (o.getMenuType()) {
                    ...
                    case NAV_MENU_S://招商
                        ...
                        String url = UrlApi.baseUrl + "/investment_list.html";
                        CommWebActivity.putUrl(url, "招商", bundle);
                    ...
                    case NAV_MENU_SERVICE:
                        Bundle b = new Bundle();
                        CommWebActivity.putUrl(UrlApi.cc_introduce,"公司介绍",b);
