package com.hayikeji.ddmanager.widget;
...
import com.hayikeji.ddmanager.utils.SystemUtils;
...
public class CustomCameraPreview extends ViewGroup implements SurfaceHolder.Callback, Camera.AutoFocusCallback {
    ...
    private void setCameraParams(int width, int height) {
        if (mCamera != null) {
            ...
            /**从列表中选取合适的分辨率*/
            Size picSize = getProperSize(pictureSizeList, ((float) height / width));
            if (null == picSize) {
     ...
     * h对应屏幕的width<p/>
     */
    private Size getProperSize(List<Size> pictureSizeList, float screenRatio) {
